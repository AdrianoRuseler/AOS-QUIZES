...
circuit.name = 'COMB01bop'; % File name
...
circuit.Xi=CombVec(Vcc,Rb,Rc,Rs,R1,R2,Beta,Vto,IS,BF); %%
...
circuit.model(1).tipo='PJF'; % for .model 

circuit.model(2).name='TBJ'; % for .model 
circuit.model(2).tipo='PNP'; % for .model 
