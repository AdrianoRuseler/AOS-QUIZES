...
circuit.name = 'COMB05op'; % File name
circuit.dir = [pwd '\'];  % Sets simulation dir
circuit.theme  = 'boost'; % clean or boost

% Config simulation
circuit.parnamesim={'Vcc','RE','RB'}; % Variables names
circuit.parname={'Vcc','RE','RB'}; % Variables names
...
circuit.Xi=CombVec(Vcc,RE,RB,IS1,BF1,IS2,BF2); %%
