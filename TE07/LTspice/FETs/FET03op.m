...
circuit.name = 'FET03op'; % File name
circuit.dir = [pwd '\'];  % Sets simulation dir
circuit.theme  = 'boost'; % clean or boost

% Config simulation
circuit.parnamesim={'Vdd','Rs','Rd','R1','R2'}; % Variables names
circuit.parname={'Vdd','Rs','Rd','R1','R2'}; % Variables names
circuit.parunit={'V','&Omega;','&Omega;','&Omega;','&Omega;'}; % Variables unit

% parameters input
Vdd=10:5:30; 
% Vz=[2.7 3.3 3.9 4.7 5.6 6.8 8.2 3.0 3.6 4.3 5.1 6.2 7.5 9.1];
R1 = combnres(1,100000,'E24'); %
R2 = combnres(1,10000,'E24'); %
...
circuit.Xi=CombVec(Vdd,Rs,Rd,R1,R2,Beta,Vto); %%
