...
circuit.name = 'FET04op'; % File name
circuit.dir = getsimdir([circuit.name '.m']); % Sets simulation dir
circuit.theme  = 'boost'; % clean or boost

% Config simulation
circuit.parnamesim={'Vdd','Rd','Rs','Rg'}; % Variables names
circuit.parname={'Vdd','Rd','Rs','Rg'}; % Variables names
...
circuit.Xi=CombVec(Vdd,Rd,Rs,Rg,Beta,Vto); %%
