...
circuit.parnamesim={'Vcc','Ra','Rb','Rc','Re','Beta','Veb','Vecsat'}; % Variables names simulation
circuit.parname={'Vcc','Ra','Rb','Rc','Re','&beta;','Veb','Vecsat'}; % Variables names quiz
circuit.parunit={'V','&Omega;','&Omega;','&Omega;','&Omega;','','V','V'}; % Variables unit

% Simulation setup 
circuit.name = 'tbjcc03pnp'; % File name
...
X0=CombVec(Vcc,Ra,Rb,Rc,Re,Beta,Veb,Vecsat); %%
...
% Generate question
quiz.enunciado = ['Para o circuito contendo um transistor TBJ do tipo PNP com polarização por divisor resistivo apresentado na Figura 1, determine:' ]; % Enunciado da pergunta!
