...
circuit.name = 'TBJ03CA'; % File name
circuit.dir = [pwd '\'];  % Sets simulation dir
circuit.theme  = 'boost'; % clean or boost

% Config simulation
circuit.parnamesim={'Vcc','Rb','Re','Cx'}; % Variables names
circuit.parname={'Vcc','Rb','Re','Cx'}; % Variables names
...
Re = combnres(1,10,'E24'); %
Rb = combnres(1,10000,'E24'); %
Cx=100e-6;
...
% Generate question
quiz.enunciado = 'Para o circuito com configuração seguidor de emissor apresentado na Figura 1, determine:';
...
% q=q+1;
% quiz.question{q}.str='Qual o valor da impedância de entrada Zi (Simp)?';
% quiz.question{q}.units={'&Omega;'};
...
% q=q+1;
% quiz.question{q}.str='Qual o valor da impedância de saída Zo?';
% quiz.question{q}.units={'&Omega;'};
...
% q=q+1;
% quiz.question{q}.str='Qual o valor da impedância de saída Zo (Simp)?';
% quiz.question{q}.units={'&Omega;'};
...
% q=q+1;
% quiz.question{q}.str='Qual o valor do ganho de tensão vo/vi (Simp)?';
% quiz.question{q}.units={'V/V'};
