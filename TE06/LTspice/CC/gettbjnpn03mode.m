function [tbjmode,logdata,logfiles]=gettbjnpn03mode(Xi)

% system(['LTspice -Run -b -ascii -netlist TBJ03CAop.asc']); % Cria o arquivo .net
...
for z=1:y
    ...
    paramstr = ['.param Vcc=' num2str(Xi(1,z)) ' Rb=' num2str(Xi(2,z)) ' Re=' num2str(Xi(3,z))];
    netlines{9}=paramstr; % Updates param line from net file
    modelstr=['.model TBJ NPN(IS=' num2str(Xi(4,z)) ' BF=' num2str(Xi(5,z)) ' VAF=' num2str(Xi(6,z)) ')'];
