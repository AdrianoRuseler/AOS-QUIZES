...
% Rb = combnres(1,10000,'E24',12); % Ativo Direto
Rb = combnres(1,100,'E24',12); % Saturação
% Rc = combres(1,10,'E12'); %
...
[tbjmode,logdata,logfiles]=gettbjnpn03mode(Xi);
...
% Generate question
quiz.enunciado = 'Para a configuração seguidor de emissor, simule o ponto de operação do circuito apresentado na Figura 1 e determine:';
