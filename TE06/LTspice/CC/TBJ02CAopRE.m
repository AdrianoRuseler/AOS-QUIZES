...
[tbjmode,logdata]=gettbjnpn02mode(Xi);
...
% Generate question
quiz.enunciado = 'Para a configuração polarização de emissor apresentada na Figura 1, simule no LTspice o ponto de operação (.op) e determine os parâmetros do modelo de pequenos sinais do TBJ:';
