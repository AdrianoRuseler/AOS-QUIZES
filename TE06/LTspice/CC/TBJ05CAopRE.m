...
[tbjmode,logdata]=gettbjnpn05mode(Xi);
...
% Generate question
quiz.enunciado = 'Para a configuração com divisor de tensão apresentada na Figura 1, simule no LTspice o ponto de operação (.op) e determine os parâmetros do modelo de pequenos sinais do TBJ:';
