...
circuit.name = 'OPAMPTBJ01D'; % File name
...
circuit.funcstr  = {'OPAMPTBJ01Dfunc1(parvalues)','OPAMPTBJ01Dfunc2(parvalues)'}; % Array of strings evalstr
...
q=q+1;
quiz.question{q}.str='Qual o valor da tensão térmica Vt?';
quiz.question{q}.units={'V'};
