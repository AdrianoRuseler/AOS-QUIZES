...
circuit.name = 'nideal01op'; % File name
...
circuit.level.varname={'Vos'};
circuit.level.varunit={'V'}; % Variables unit
...
circuit.Xi=CombVec(Vs,Vi,R1,R2,RL,Vos); %%
...
% % Generate question
quiz.enunciado = 'Para o circuito amplificador não-ideal com tensão de offset apresentado na Figura 1, determine:';
...
% 
% q=4;
% quiz.question{q}.str='d)  Qual o valor da corrente em R2?';
