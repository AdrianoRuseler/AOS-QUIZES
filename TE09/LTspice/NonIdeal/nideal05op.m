...
circuit.name = 'nideal05op'; % File name
...
circuit.funcstr  = {'nideal01func1(parvalues)','nideal05func2(parvalues)'}; % Array of strings evalstr
...
q=q+1;
quiz.question{q}.str='Qual o valor da resistência Rx para compensar Ib?';
