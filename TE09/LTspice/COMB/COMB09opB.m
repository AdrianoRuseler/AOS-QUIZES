...
circuit.name = 'COMB09op'; % File name
...
% Generate question
quiz.enunciado = 'Analise e simule no LTspice o ponto de operação (.op) do circuito fonte de tensão positiva apresentado na Figura 1 e determine:';
