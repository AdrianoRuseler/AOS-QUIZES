...
[tbjmode,logdata]=gettbjnpn04mode(Xi);
...
% Generate question
quiz.enunciado = 'Para o circuito com a configuração realimentação de coletor apresentado na Figura 1, determine:';
