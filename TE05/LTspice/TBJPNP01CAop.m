...
circuit.name = 'TBJPNP01CAop'; % File name
...
% Generate question
quiz.enunciado = 'Para a configuração emissor comum de polarização fixa, simule no LTspice o ponto de operação (.op) do circuito apresentado na Figura 1 e determine:';
...
% q=q+1;
% quiz.question{q}.str='b) Qual o valor do ganho &beta; em CA?';
% quiz.question{q}.units={'A/A'};
...
% 
% q=q+1;
% quiz.question{q}.str='Qual o valor de Rpi?';
