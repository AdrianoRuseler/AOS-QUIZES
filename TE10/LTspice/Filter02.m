...
% Sets simulation dir
circuit.name = 'Filter02'; % File name
...
circuit.funcstr  = {'filter01func1(parvalues)','filter01func2(parvalues)','filter02func3(parvalues)','filter02func4(parvalues)'}; % Array of strings evalstr
