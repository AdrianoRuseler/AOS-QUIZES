...
% Sets simulation dir
circuit.name = 'Filter04'; % File name
...
circuit.funcstr  = {'filter04func1(parvalues)','filter01func2(parvalues)','filter01func3(parvalues)','filter01func4(parvalues)'}; % Array of strings evalstr
