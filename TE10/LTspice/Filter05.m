...
% Sets simulation dir
circuit.name = 'Filter05'; % File name
circuit.dir = [pwd '\'];  % Sets simulation dir
circuit.theme  = 'boost'; % clean or boost

% Config simulation
circuit.parnamesim={'Vs','R1','R2','C1','RL'}; % Variables names
circuit.parname={'Vs','R1','R2','C1','RL'}; % Variables names
circuit.parunit={'V','&Omega;','&Omega;','F','&Omega;'}; % Variables unit

circuit.funcstr  = {'filter04func1(parvalues)','filter01func2(parvalues)','filter02func3(parvalues)','filter02func4(parvalues)'}; % Array of strings evalstr
...
circuit.Xi=CombVec(Vs,R1,R2,C1,RL); %%
...
% % Generate question
quiz.enunciado = 'Para o filtro passa-altas apresentado na Figura 1, determine:';

% Text a ser colocado abaixo da figura
quiz.extratext{1} = 'Forma padronizada: \(H(s) = H_o\dfrac{\dfrac{s}{ \omega_o }}{1+\dfrac{s}{ \omega_o }} \)';
